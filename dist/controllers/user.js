    ...
    try {
        ...
        return res.status(201).json({
            user: {
                ...
                email,
                streamToken,
                avatar: (_a = user === null || user === void 0 ? void 0 : user.avatar) === null || _a === void 0 ? void 0 : _a.url,
            },
        });
    }
    catch (error) {
    ...
    try {
        ...
        res.status(200).json({
            user: {
                ...
                followers: (_b = userExists === null || userExists === void 0 ? void 0 : userExists.following) === null || _b === void 0 ? void 0 : _b.length,
                posts: (_c = userExists === null || userExists === void 0 ? void 0 : userExists.posts) === null || _c === void 0 ? void 0 : _c.length,
                workspace: (_d = userExists === null || userExists === void 0 ? void 0 : userExists.workspaces) === null || _d === void 0 ? void 0 : _d.length,
...
const updateProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user)
        return res.status(404).json({ error: 'User not found' });
    if (avatar) {
        if ((_e = user.avatar) === null || _e === void 0 ? void 0 : _e.public_id) {
